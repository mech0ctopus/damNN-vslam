...
from utils.read_odom import read_odom, normalize, denormalize
from models.losses import root_mean_squared_error
...
if __name__=='__main__':
    ...
    # #     model.load_weights(f"{model_name}_weights_best.tf")
    # #     rpyxyz_est=model.predict([image1,image2])

    #     print('Predicted RPYXYZ:')
    #     rpyxyz_est=np.hstack((rpyxyz_est[0],rpyxyz_est[1])).reshape((6,))
    #     print(rpyxyz_est)     
